 ...
 * (/home/voongjame/.aws/credentials) where the sample code will load the
 * credentials from.
 * <p>
...
public class S3Sample {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * (/home/voongjame/.aws/credentials).
		 */
		...
		AmazonS3 s3 = new AmazonS3Client(credentials); // this line instantiates
														// a new client
...
// don't forget to do exceptions for both server and client side
// uml class diagram to be done before code started
// Requirements: Java, AWS, Amazon credentials
// Compiling: JRE for Eclipse/terminal
// Can generate java.doc through eclipse automatically. Annotate code properly
